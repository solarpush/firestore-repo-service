...
const enSidebar = [
  {
    ...
    items: [
      ...
      { text: "CRUD Server", link: "/guide/crud" },
      { text: "Change History", link: "/guide/history" },
      { text: "Firestore → Storage & Search Sync", link: "/guide/sync" },
...
const frSidebar = [
  {
    ...
    items: [
      ...
      { text: "Serveur CRUD", link: "/fr/guide/crud" },
      { text: "Historique des changements", link: "/fr/guide/history" },
      { text: "Firestore → Storage & Search Sync", link: "/fr/guide/sync" },
